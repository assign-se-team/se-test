import { inject, version, ref, watchEffect, watch, getCurrentInstance, unref, useSSRContext, createApp, effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as sanitizeStatusCode, p as createHooks, h as createError$1, q as isEqual, r as defuFn, t as toRouteMatcher, v as createRouter, x as defu, y as stringifyParsedURL, z as stringifyQuery, A as parseQuery, B as klona } from '../runtime.mjs';
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-33de15fd"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BH79faQb.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-IA-tjXqK.mjs').then((r) => r.default || r));
